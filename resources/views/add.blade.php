                            ...
                            <div class="containerForm">
                                <div class="containerAddInput">
                                    <div class="containerAddText">
                                        ...
                                        <input type="text" name="" id="DiseaseName" placeholder="Insert Disease Name here..." class="InputAdd">
                                    </div>
                                </div>
                                <div class="containerInfoInput">
                                    <div class="containerAddText">
                                        <label for="DiseaseInformation">Disease Information</label>
                                        <textarea id="DiseaseInformation" name="DiseaseInformation" maxlength="200" rows="4" cols="50" class="InputInfo" placeholder="Insert Disease Information here..."></textarea>
